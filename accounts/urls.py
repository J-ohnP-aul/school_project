...
from .views import admin_dashboard, register_view, login_view, logout_view, dashboard, users_list, aplicant_list, complete_profile, search_students, delete_user, delete_applicant, create_user, applicant_detail
